...
export function MessageList({ messages, isLoading }: MessageListProps) {
  ...
  return (
    <div 
      ref={containerRef}
      className="h-full overflow-y-auto overflow-x-hidden bg-gradient-to-b from-gray-50 to-white"
    >
      <div className="max-w-4xl mx-auto px-3 sm:px-4 py-4 min-h-full w-full">
